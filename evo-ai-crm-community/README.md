...
- **Automated Backup & Restore Scripts** (`scripts/restore.sh`)

---

## 🛠 Backup and Restore

Evo CRM Backup handles automated exports to AWS S3, GCS or local storage (`storage/backups`).

To manually restore a backup archive generated by Evo CRM inside a Docker/Portainer environment:

```bash
# Copie o arquivo de backup para o servidor e rode o script
chmod +x scripts/restore.sh
./scripts/restore.sh backup_20260701_030000.tar.gz
```
