class AgentBots::MessageCreator
  ...
  def create_message_with_fallback(content, conversation, content_type:, content_attributes:, attachments: nil)
  ...
  def create_direct_message(content, conversation, content_type:, content_attributes:, attachments: nil)
    message_attributes = {
    ...
    if attachments.present?
      attachments.each do |uploaded_file|
        message.attachments.build(file: uploaded_file)
      end
    end
  ...
  def create_message_with_builder(content, conversation, content_type:, content_attributes:, attachments: nil)
