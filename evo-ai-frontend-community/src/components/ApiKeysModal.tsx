  ...
  return (
    <>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="col-span-3 relative">
                  <Input
                    ...
                    placeholder={
                      isEditingKey ? t('form.placeholders.keyEdit') : t('form.placeholders.keyNew')
                    }
                  />
                  <Button
                    variant="ghost"
                  ...
                  <div key={apiKey.id} className="flex items-center justify-between p-4 border rounded-lg">
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        {apiKey.base_url && (
                          <span className="text-sm text-muted-foreground">{apiKey.base_url}</span>
                        )}
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button variant="ghost" size="sm" onClick={() => handleDeleteClick(apiKey)}>
      ...
      <AppModal
        ...
        description={t('deleteDialog.description', { name: keyToDelete?.name })}
