...
export default function MacroFormModal({ isOpen, onClose, macro, onSuccess }: MacroFormModalProps) {
  ...
  return (
    <AppModal
      ...
      title={isEditing ? t('modal.title.edit') : t('modal.title.create')}
      maxWidthClass="max-w-6xl w-[85vw] min-w-[700px] max-h-[90vh] overflow-y-auto bg-sidebar border-sidebar-border"
      onClose={onClose}
      footer={
        <>
          <Button
      ...
      >
              ...
              >
                <CardHeader className="p-4">
                  <div className="flex items-center gap-2">
                    ...
                    <CardTitle className="text-base">{t('modal.form.visibilityPersonal')}</CardTitle>
                  </div>
                </CardHeader>
                <CardContent className="p-4 pt-0">
                  <CardDescription className="text-sm">{t('modal.form.visibilityPersonalDesc')}</CardDescription>
                </CardContent>
              </Card>
              ...
              >
                <CardHeader className="p-4">
                  <div className="flex items-center gap-2">
                    ...
                    <CardTitle className="text-base">{t('modal.form.visibilityGlobal')}</CardTitle>
                  </div>
                </CardHeader>
                <CardContent className="p-4 pt-0">
                  <CardDescription className="text-sm">{t('modal.form.visibilityGlobalDesc')}</CardDescription>
                </CardContent>
              </Card>
            </div>
          </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-lg font-medium text-sidebar-foreground">{t('modal.form.actionsTitle')}</h3>
              <p className="text-sm text-sidebar-foreground/60">{t('modal.form.actionsSubtitle')}</p>
            </div>
            <Button
              type="button"
              variant="outline"
