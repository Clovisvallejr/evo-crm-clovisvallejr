...
import { Mail, MailOpen, HardDrive, KeyRound, MessageSquare, Sparkles, Puzzle, Globe, Cable, DatabaseBackup } from 'lucide-react';
...
const navItems = [
  ...
  { key: 'backup', path: '/settings/admin/backup', icon: DatabaseBackup },
] as const;
