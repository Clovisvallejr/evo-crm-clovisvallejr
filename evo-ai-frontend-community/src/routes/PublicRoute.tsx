...
const PublicRoute = ({ children }: PublicRouteProps) => {
  ...
  if (isAuthenticated) {
    // Widget, Survey and Quotes should always be accessible regardless of auth status
    if (location.pathname === '/widget' || location.pathname.startsWith('/survey/responses/') || location.pathname.startsWith('/quotes/')) {
      return <>{children}</>;
    }
