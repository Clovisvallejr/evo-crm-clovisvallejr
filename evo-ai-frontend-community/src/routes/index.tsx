    ...
    <BrowserRouter>
      <RouterGuard>
        <Routes>
          ...
          {/* Rota pública de visualização de orçamentos */}
          <Route
            path="/quotes/:token/public"
            element={
              <PublicRoute>
                <QuoteView />
              </PublicRoute>
          ...
          <Route
            ...
            element={
              <PrivateRoute>
                <CustomerRoute>
                  <MainLayout>
                    <PermissionRoute resource="orders" action="read">
                      <Orders />
                    </PermissionRoute>
                  </MainLayout>
                </CustomerRoute>
          ...
          <Route
            ...
            element={
              <PrivateRoute>
                <CustomerRoute>
                  <MainLayout>
                    <PermissionRoute resource="quotes" action="read">
                      <Quotes />
                    </PermissionRoute>
                  </MainLayout>
                </CustomerRoute>
