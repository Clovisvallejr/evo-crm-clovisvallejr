...
class EvoCrmClient:
    ...
    def __init__(self):
        ...
        # Public-facing URL (used to build links sent to customers)
        # Falls back to base_url if not explicitly set
        self.public_url = os.getenv("EVO_AI_CRM_PUBLIC_URL", self.base_url).rstrip("/")
