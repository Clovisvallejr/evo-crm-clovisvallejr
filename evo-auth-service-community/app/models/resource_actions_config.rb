...
class ResourceActionsConfig
  RESOURCES = {
    ...
    orders: {
      ...
      actions: {
        read: { name: 'View', description: 'View orders and their details' },
        create: { name: 'Create', description: 'Create new orders' },
        update: { name: 'Update', description: 'Update order information and status' },
        delete: { name: 'Delete', description: 'Delete orders' },
        bulk_action: { name: 'Bulk Action', description: 'Perform bulk actions on orders' },
        approve_payment: { name: 'Approve Payment', description: 'Approve order payment' },
        update_logistics: { name: 'Update Logistics', description: 'Update order logistics' }
      }
    },

    quotes: {
      name: 'Quotes',
      description: 'Quote management and proposals',
      actions: {
        read: { name: 'View', description: 'View quotes and their details' },
        create: { name: 'Create', description: 'Create new quotes' },
        update: { name: 'Update', description: 'Update quote information and status' },
        delete: { name: 'Delete', description: 'Delete quotes' },
        approve: { name: 'Approve', description: 'Approve a quote to become an order' }
      }
    },

    dashboard: {
      name: 'Dashboard',
      description: 'System dashboards and analytics',
      actions: {
        view_admin: { name: 'View Admin', description: 'View admin financial dashboards' },
        instance_status: { name: 'Instance Status', description: 'View instance status' },
        system_info: { name: 'System Info', description: 'View system information' }
      }
    }
